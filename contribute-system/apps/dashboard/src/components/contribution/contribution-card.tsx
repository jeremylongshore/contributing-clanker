...
interface ContributionCardProps {
  bounty: ContributionCardData;
  onClick?: () => void;
}

export function ContributionCard({ bounty, onClick }: ContributionCardProps) {
  const getDifficultyStyle = (difficulty: ContributionCardData['difficulty']) => {
    switch (difficulty) {
      case 'easy':
