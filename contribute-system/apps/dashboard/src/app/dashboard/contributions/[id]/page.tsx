...
import { useContribution } from '@/lib/hooks/use-contributions';
...
export default function BountyDetailPage() {
  ...
  const { bounty, loading: bountyLoading } = useContribution(id);
  ...
  if (bountyLoading) {
    return (
      <>
        <Header title="Contribution Details" />
  ...
  if (!bounty) {
    return (
      <>
        <Header title="Contribution Not Found" />
        <div className="p-6">
          <div className="rounded-lg border border-dashed border-gray-300 p-8 text-center">
            <p className="text-gray-500">Contribution not found</p>
            <Link
          ...
          <div className="space-y-6">
            ...
            <div className="rounded-xl bg-white p-6 shadow-sm dark:bg-gray-800">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-sm text-gray-500 dark:text-gray-400">Contribution Value</p>
