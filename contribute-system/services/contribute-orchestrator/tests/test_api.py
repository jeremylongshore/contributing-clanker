...
from contribute_agent.api import app
...
class TestHealthEndpoint:
    ...
    def test_health_check(self, client):
        ...
        assert data["service"] == "contribute-orchestrator"
...
class TestStartBountyEndpoint:
    ...
    def test_start_bounty_returns_session_info(self, client):
        ...
        with patch("contribute_agent.api.graph") as mock_graph:
            mock_graph.ainvoke = AsyncMock(return_value={})

            response = client.post(
                "/api/contribution/start",
                json={
                    "contribution_id": "test-123",
            ...
            assert data["contribution_id"] == "test-123"
    ...
    def test_start_bounty_missing_fields(self, client):
        ...
        response = client.post(
            "/api/contribution/start",
            json={"contribution_id": "test-123"},  # Missing issue_url and repo
        )
...
class TestBountyStatusEndpoint:
    ...
    def test_get_status_returns_current_state(self, client):
        ...
        with patch("contribute_agent.api.graph") as mock_graph:
            ...
            response = client.get("/api/contribution/test-123/status")
...
class TestApproveEndpoint:
    ...
    def test_approve_updates_state(self, client):
        ...
        with patch("contribute_agent.api.graph") as mock_graph:
            ...
            response = client.post("/api/contribution/test-123/approve")
